...
const modules = [
  ...
  { name: "Báo cáo sản phẩm",  roles: { "quan-tri-vien": { xem:true, tao:false,sua:false,xoa:true,  phe_duyet:true  }, "quan-ly": { xem:true, tao:false,sua:false,xoa:false, phe_duyet:true  }, "kiem-dinh-vien": { xem:true, tao:false, sua:false, xoa:false, phe_duyet:false }, "nhan-vien-nhap-lieu": { xem:true, tao:false, sua:false,xoa:false, phe_duyet:false }, "doi-tac": { xem:false, tao:false, sua:false, xoa:false, phe_duyet:false }, "nguoi-xem": { xem:false, tao:false, sua:false, xoa:false, phe_duyet:false } } },
];
