                ...
                return (
                    ...
                    >
                        ...
                        {typeof tab.badge === "number" && (
                            <span className="inline-flex items-center justify-center min-w-[20px] h-5 px-1.5 rounded-full text-[11px] font-medium bg-brand-50 text-brand-700 border border-brand-100">
                                {tab.badge}
                            </span>
                        )}
