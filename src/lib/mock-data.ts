...
export type RolePerm = { xem: boolean; tao: boolean; sua: boolean; xoa: boolean; xuat: boolean; phe_duyet: boolean };
...
export const defaultPermissions: Record<string, Record<string, RolePerm>> = {
  "super-admin": {
    "Doanh nghiệp": { xem: true, tao: true, sua: true, xoa: true, xuat: true, phe_duyet: true },
    "Cơ sở": { xem: true, tao: true, sua: true, xoa: true, xuat: true, phe_duyet: true },
    "Sản phẩm": { xem: true, tao: true, sua: true, xoa: true, xuat: true, phe_duyet: true },
    "Sự kiện truy xuất": { xem: true, tao: true, sua: true, xoa: true, xuat: true, phe_duyet: true },
    "Tem nhãn (UID/QR)": { xem: true, tao: true, sua: true, xoa: true, xuat: true, phe_duyet: true },
    "Chứng chỉ": { xem: true, tao: true, sua: true, xoa: true, xuat: true, phe_duyet: true },
    "Báo cáo": { xem: true, tao: true, sua: true, xoa: true, xuat: true, phe_duyet: true },
    "Quản trị người dùng": { xem: true, tao: true, sua: true, xoa: true, xuat: true, phe_duyet: true },
    "Tích hợp API": { xem: true, tao: true, sua: true, xoa: true, xuat: true, phe_duyet: true },
    "Báo cáo sản phẩm": { xem: true, tao: true, sua: true, xoa: true, xuat: true, phe_duyet: true },
  },
  "bo-ban-nganh-admin": {
    "Doanh nghiệp": { xem: true, tao: true, sua: true, xoa: true, xuat: true, phe_duyet: false },
    "Cơ sở": { xem: true, tao: true, sua: true, xoa: true, xuat: true, phe_duyet: false },
    "Sản phẩm": { xem: true, tao: true, sua: true, xoa: true, xuat: true, phe_duyet: false },
    "Sự kiện truy xuất": { xem: true, tao: false, sua: false, xoa: false, xuat: true, phe_duyet: false },
    "Tem nhãn (UID/QR)": { xem: true, tao: true, sua: true, xoa: true, xuat: false, phe_duyet: false },
    "Chứng chỉ": { xem: true, tao: false, sua: false, xoa: false, xuat: false, phe_duyet: false },
    "Báo cáo": { xem: true, tao: false, sua: false, xoa: false, xuat: true, phe_duyet: false },
    "Quản trị người dùng": { xem: true, tao: true, sua: true, xoa: true, xuat: false, phe_duyet: false },
    "Tích hợp API": { xem: true, tao: true, sua: true, xoa: true, xuat: false, phe_duyet: false },
    "Báo cáo sản phẩm": { xem: true, tao: false, sua: false, xoa: false, xuat: true, phe_duyet: true },
  },
  "bo-ban-nganh-ops": {
    "Doanh nghiệp": { xem: true, tao: false, sua: false, xoa: false, xuat: true, phe_duyet: false },
    "Cơ sở": { xem: true, tao: false, sua: false, xoa: false, xuat: true, phe_duyet: false },
    "Sản phẩm": { xem: true, tao: false, sua: false, xoa: false, xuat: true, phe_duyet: false },
    "Sự kiện truy xuất": { xem: true, tao: true, sua: true, xoa: true, xuat: true, phe_duyet: false },
    "Tem nhãn (UID/QR)": { xem: false, tao: false, sua: false, xoa: false, xuat: false, phe_duyet: false },
    "Chứng chỉ": { xem: true, tao: true, sua: true, xoa: true, xuat: false, phe_duyet: true },
    "Báo cáo": { xem: true, tao: false, sua: false, xoa: false, xuat: true, phe_duyet: false },
    "Quản trị người dùng": { xem: false, tao: false, sua: false, xoa: false, xuat: false, phe_duyet: false },
    "Tích hợp API": { xem: false, tao: false, sua: false, xoa: false, xuat: false, phe_duyet: false },
    "Báo cáo sản phẩm": { xem: true, tao: false, sua: false, xoa: false, xuat: true, phe_duyet: false },
  },
  "so-tinh-admin": {
    "Doanh nghiệp": { xem: true, tao: false, sua: false, xoa: false, xuat: true, phe_duyet: false },
    "Cơ sở": { xem: true, tao: false, sua: false, xoa: false, xuat: true, phe_duyet: false },
    ...
    "Sự kiện truy xuất": { xem: true, tao: false, sua: false, xoa: false, xuat: true, phe_duyet: false },
    "Tem nhãn (UID/QR)": { xem: false, tao: false, sua: false, xoa: false, xuat: false, phe_duyet: false },
    "Chứng chỉ": { xem: false, tao: false, sua: false, xoa: false, xuat: false, phe_duyet: false },
    "Báo cáo": { xem: true, tao: false, sua: false, xoa: false, xuat: true, phe_duyet: false },
    "Quản trị người dùng": { xem: true, tao: true, sua: true, xoa: true, xuat: false, phe_duyet: false },
    "Tích hợp API": { xem: false, tao: false, sua: false, xoa: false, xuat: false, phe_duyet: false },
    "Báo cáo sản phẩm": { xem: true, tao: false, sua: false, xoa: false, xuat: true, phe_duyet: false },
  ...
  "dai-ly-admin": {
    ...
    "Cơ sở": { xem: true, tao: true, sua: true, xoa: true, xuat: true, phe_duyet: false },
    "Sản phẩm": { xem: true, tao: true, sua: true, xoa: true, xuat: true, phe_duyet: false },
    "Sự kiện truy xuất": { xem: false, tao: false, sua: false, xoa: false, xuat: false, phe_duyet: false },
    "Tem nhãn (UID/QR)": { xem: true, tao: true, sua: true, xoa: true, xuat: false, phe_duyet: false },
    "Chứng chỉ": { xem: false, tao: false, sua: false, xoa: false, xuat: false, phe_duyet: false },
    "Báo cáo": { xem: true, tao: false, sua: false, xoa: false, xuat: true, phe_duyet: false },
    "Quản trị người dùng": { xem: true, tao: true, sua: true, xoa: true, xuat: false, phe_duyet: false },
  ...
  "dai-ly-ops": {
    ...
    "Sản phẩm": { xem: true, tao: false, sua: false, xoa: false, xuat: true, phe_duyet: false },
    "Sự kiện truy xuất": { xem: false, tao: false, sua: false, xoa: false, xuat: false, phe_duyet: false },
    "Tem nhãn (UID/QR)": { xem: true, tao: false, sua: false, xoa: false, xuat: false, phe_duyet: false },
    "Chứng chỉ": { xem: true, tao: false, sua: false, xoa: false, xuat: false, phe_duyet: false },
    "Báo cáo": { xem: true, tao: false, sua: false, xoa: false, xuat: true, phe_duyet: false },
    "Quản trị người dùng": { xem: false, tao: false, sua: false, xoa: false, xuat: false, phe_duyet: false },
    "Tích hợp API": { xem: true, tao: true, sua: true, xoa: true, xuat: false, phe_duyet: false },
